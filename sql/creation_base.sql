...
-- Table Creation
CREATE TABLE projets IF NOT EXISTS(
...
-- Data Insertion
INSERT INTO Projets(projet_titre,projet_stitre,projet_d,projet_f1,projet_f2,projet_f3,projet_description,projet_photo)
    VALUES
    ("Site e-commerce",
